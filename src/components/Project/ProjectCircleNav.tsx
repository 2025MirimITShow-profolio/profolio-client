...
const ProjectCircleNav: React.FC<ProjectCircleNavProps> = ({ count, activeIdx, onChange, angle }) => {
  ...
  return (
    <div className={styles.circleNavContainer} style={{ width: svgW, height: svgH }}>
      <svg width={svgW} height={svgH} className={styles.circleSvg} style={{ position: 'absolute', left: 0, top: 0 }}>
        {/* 전체 원 */}
        <circle
          cx={cx}
          cy={cy}
