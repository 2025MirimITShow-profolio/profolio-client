...
export function Project({
	...
	const member =
		allMember == null || allMember.length === 0 ? [] : allMember.split(",");
	const profile =
		allProfile == null || allMember.length === 0
			? []
			: allProfile.split(",");
		...
		<div className={styles.project}>
			...
			<div style={{ width: "26.7%" }}>
				<div
					...
					style={{ backgroundColor: isDark ? "#6C6C73" : "#EEEEEE" }}
				>
					<div
						style={{
					...
					{data.length > 0 &&
						data.map((d, i) => (
							<Project
								...
								color={d.color}
								date={d.end_date}
								allMember={d.team_members}
								isDark={isDark}
								allProfile={d.member_profile}
							/>
						))}
				</ProjectContainer>
			</div>
