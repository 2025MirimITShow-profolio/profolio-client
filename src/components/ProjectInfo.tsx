    ...
    return (
        <div className={styles.container}>
            ...
            >
                ...
                <svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg" className={styles.showBtn} onClick={() => handleClick(index)}>
                    <path d="M13.5 0L13.5 27" stroke="white" stroke-width="2"/>
                    <path d="M27 13.5L-3.27826e-07 13.5" stroke="white" stroke-width="2"/>
                </svg>            </div>
            {show===index &&
